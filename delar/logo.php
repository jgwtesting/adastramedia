<svg version="1.1" id="logo2" 
        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:a="http://ns.adobe.com/AdobeSVGViewerExtensions/3.0/"
        x="0px" y="0px" width="8rem"  viewBox="1 108 400 169" enable-background="new 1 108 400 169"
        xml:space="preserve">
    <defs>
    </defs>
    <path  id="logo-shape" fill-rule="evenodd" clip-rule="evenodd" fill="var(--navigation-link-color)" stroke="var(--navigation-link-color)" stroke-width="8" stroke-linejoin="round" stroke-miterlimit="3" d="
